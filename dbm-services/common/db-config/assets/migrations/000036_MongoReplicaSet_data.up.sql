...
INSERT INTO `tb_config_name_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_name`, `value_type`, `value_default`, `value_allowed`, `value_type_sub`, `flag_status`, `flag_disable`, `flag_locked`, `flag_encrypt`, `need_restart`, `value_formula`, `extra_info`, `conf_name_lc`, `order_index`, `since_version`, `description`, `created_at`, `updated_at`, `stage`) VALUES (30586,'MongoReplicaSet','dbconf','Mongodb-7','cacheSizeGB','INT','10','[10,80]','RANGE',1,0,0,0,1,NULL,NULL,'db配置',-1,NULL,NULL,'2025-03-11 10:35:10','2025-03-11 10:35:10',0);
INSERT INTO `tb_config_name_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_name`, `value_type`, `value_default`, `value_allowed`, `value_type_sub`, `flag_status`, `flag_disable`, `flag_locked`, `flag_encrypt`, `need_restart`, `value_formula`, `extra_info`, `conf_name_lc`, `order_index`, `since_version`, `description`, `created_at`, `updated_at`, `stage`) VALUES (30587,'MongoReplicaSet','dbconf','Mongodb-7','destination','STRING','file','file','ENUM',1,0,0,0,1,NULL,NULL,'db配置',-1,NULL,NULL,'2025-03-11 10:35:10','2025-03-11 10:35:10',0);
INSERT INTO `tb_config_name_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_name`, `value_type`, `value_default`, `value_allowed`, `value_type_sub`, `flag_status`, `flag_disable`, `flag_locked`, `flag_encrypt`, `need_restart`, `value_formula`, `extra_info`, `conf_name_lc`, `order_index`, `since_version`, `description`, `created_at`, `updated_at`, `stage`) VALUES (30588,'MongoReplicaSet','dbconf','Mongodb-7','key_file','STRING','','','ENUM',1,0,0,0,1,NULL,NULL,'db配置',-1,NULL,NULL,'2025-03-11 10:35:10','2025-03-11 10:35:10',0);
INSERT INTO `tb_config_name_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_name`, `value_type`, `value_default`, `value_allowed`, `value_type_sub`, `flag_status`, `flag_disable`, `flag_locked`, `flag_encrypt`, `need_restart`, `value_formula`, `extra_info`, `conf_name_lc`, `order_index`, `since_version`, `description`, `created_at`, `updated_at`, `stage`) VALUES (30589,'MongoReplicaSet','dbconf','Mongodb-7','oplogSizeMB','INT','10240','[10240,81920]','RANGE',1,0,0,0,1,NULL,NULL,'db配置',-1,NULL,NULL,'2025-03-11 10:35:10','2025-03-11 10:35:10',0);
INSERT INTO `tb_config_name_def` (`id`, `namespace`, `conf_type`, `conf_file`, `conf_name`, `value_type`, `value_default`, `value_allowed`, `value_type_sub`, `flag_status`, `flag_disable`, `flag_locked`, `flag_encrypt`, `need_restart`, `value_formula`, `extra_info`, `conf_name_lc`, `order_index`, `since_version`, `description`, `created_at`, `updated_at`, `stage`) VALUES (30590,'MongoReplicaSet','dbconf','Mongodb-7','slowOpThresholdMs','INT','200','[100,2000]','RANGE',1,0,0,0,1,NULL,NULL,'db配置',-1,NULL,NULL,'2025-03-11 10:35:10','2025-03-11 10:35:10',0);
/*!50112 SET @disable_bulk_load = IF (@is_rocksdb_supported, 'SET SESSION rocksdb_bulk_load = @old_rocksdb_bulk_load', 'SET @dummy_rocksdb_bulk_load = 0') */;
/*!50112 PREPARE s FROM @disable_bulk_load */;
/*!50112 EXECUTE s */;
/*!50112 DEALLOCATE PREPARE s */;
